  ...
  <div class="lun-bo">
    <main id="main">
      ...
      <section>
        ...
        <div class="tupian">
          <img
            src="../NetEase-Cloud/src/assets/img/test/bg-1.jpg"
            class="image"
          />
        </div>
        <!-- 小圆点 -->
...
var picture = [
  "../NetEase-Cloud/src/assets/img/test/bg-1.jpg",
  "../NetEase-Cloud/src/assets/img/test/bg-2.jpg",
  "../NetEase-Cloud/src/assets/img/test/bg-3.jpg",
  "../NetEase-Cloud/src/assets/img/test/bg-4.jpg",
  "img/images/5.jpg",
  "img/images/6.jpg",
];
